      ...
      <div class="d-flex">
          <div class="form-group">
              <select id="select" onchange="selectChange(this.value)" class="form-select mt-3" name="comType" style="width: 200px;" required>
                  <option selected disabled hidden value="">-Choose Type-</option>
          ...
          <div class="form-group">
              ...
              <button type="submit" class="btn btn-primary" name="proceed" style="width: 100px;"><i class="fa fa-search" aria-hidden="true"></i></button>
